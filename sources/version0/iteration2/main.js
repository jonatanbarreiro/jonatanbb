...
(function () {
  ...
  const KLOGO = 0.866764;                           // maps the bb annulus mid-radius (138.446) to r=120
  const HW = 10.5 * KLOGO / 2;                      // half stroke, viewBox units (= 4.5505)
  ...
  function draw() {
    ...
    // (9.1010) equals the logo's stroke mapped into the viewBox, half = 4.5505.
    const halfStroke = 4.5505 * scale, rOut = R + halfStroke, rIn = R - halfStroke;
