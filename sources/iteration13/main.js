...
(function () {
  ...
  // holds its glow a moment, then falls off so it's fully gone ~4s after illumination — a
  // slow ember fade (τ trimmed so a full-bright fade lands ~1s sooner). The points reuse it
  // for their own ember tail. (The b faces no longer cool — they light only, see below.)
  const COOL_TAU = 1.6, COOL_BETA = 1.6;
