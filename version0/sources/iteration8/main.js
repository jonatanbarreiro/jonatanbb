...
(function () {
  ...
  const FONT_FRAC = 0.546;            // letter font px as a fraction of the ring thickness (30% shorter)
  ...
  function sizeCanvas() {
    ...
    if (lctx) fitCanvas(lettersCanvas, lctx, 0.5 * s);       // letters, a hair of diffusion
  }
