...
window.CONTENT_EN = {
  ...
  // the eyebrow now carries the CV link —the paper trail sits at the top, where a
  // recruiter first looks, instead of competing with the contact section
  eyebrow: 'Mathematician · Predoctoral researcher · <a class="cv-link" href="assets/jonatanbb-cv-en.pdf">CV (PDF)</a>',
  lede:    "Mathematician by training, with theoretical roots —complex, functional and harmonic analysis— but a lasting knack for modelling problems, mathematical or not. Four years of applied research on LiDAR point clouds added the practical layer —C++, Python, and the everyday craft of building software— to an already solid grounding in applied mathematics. I'm now finishing my PhD in Galicia. My second article is in the writing, and this site lays the ground for the move that comes after it: out of academia, into industry.",

  // About
  k_about: "About",
  ab1: "I'm a mathematician by training —a degree and a research master's from the Universidad Autónoma de Madrid, where my focus settled on complex and functional analysis, then a Master of Arts in Mathematics from the University of Kansas, where I did some research in harmonic analysis and spent a year teaching calculus.",
  ...
  ab3: "The thread through all of it is modelling —I've always had a way of turning a loose problem, mathematical or not, into something with workable structure. And I care about methods that are not only useful and correct, but sensible, where you can understand <em>why</em> the model forces the answer. Right now, all of that is pointed at finishing my PhD.",
  ...
  e3d: "Spring semester —teaching assistant for Math 147 Calculus III (Honors), with Prof. E. Gavosto: the highest calculus course graduate students were allowed to assist in. Taught classes, graded, ran the Help Room, and handled the 3D printing of student projects.",
  ...
  ed2d: "Research initiation specialization. Thesis: <em>El Teorema de la Corona</em> (The Corona Theorem), advised by J. L. Fernández.",
  ...
  pubintro: "Two pieces of work are on my desk right now. One is my second article —a decoupled random-sampling Hough approach to detecting lines, and now also circles, in 2D point clouds; the research is done and the write-up is under way. The other is this very site, raised from a bare hello-world file in a couple of dedicated weeks —AI-assisted, hand-driven, no framework in between. It didn't make me a web developer, but it did mean a non-trivial run through web design and development, and through designing AI workflows that stay deliberate and accountable.",
  ...
  foot:  '<a href="https://github.com/jonatanbarreiro/jonatanbb">AI-assisted, hand-driven</a>.',
};
